...
vagrant ssh -c 'export GIT_SSH_COMMAND="ssh -o StrictHostKeyChecking=no" && git clone git@github.com:kubernetes-sigs/kubespray.git /home/vagrant/kubespray' node1
